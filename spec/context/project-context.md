...
> For detailed non-functional requirements and architecture decisions, see [`../architecture/nfr-and-architecture.md`](../architecture/nfr-and-architecture.md).
...
- [NFR & Architecture](../architecture/nfr-and-architecture.md) — non-functional requirements and architecture outline
- [Use Case Template](../use-cases/use-case-template.md) — template for feature specifications
- [QA & Verification](../qa/qa-and-verification.md) — test strategy and verification checklists
